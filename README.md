...
![Counterfactual Preview](img/img3.jpg)
...
![CLIP Verification](img/img1.jpg)
...
```
├── cf_domaingen_colab.ipynb    # Main Colab notebook (all 4 stages)
├── README.md                   # This file
├── img/
│   ├── img1.jpg                # CLIP verification results
│   ├── img2.jpg                # Final training results & confusion matrices
│   ├── img3.jpg                # Counterfactual generation previews
│   └── img4.jpg                # OfficeHome domain sample grid
└── outputs/                    # Generated by notebook
    ├── attributes.json         # VLM-mined edit instructions
    ├── counterfactuals/        # Stage 2 generated images
    ├── verified/               # Stage 3 CLIP-filtered images
